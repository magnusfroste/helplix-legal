...
export const translations: Record<CountryCode, Translations> = {
  BR: {
    ...
    auth: {
      ...
      description:
        "O Helplix ajuda você a documentar sua situação jurídica fazendo perguntas estruturadas e criando uma visão geral abrangente.",
    ...
    welcome: {
      howItWorks: {
        title: "Como funciona",
        description:
          "Helplix é seu assistente de documentação jurídica. Ele faz perguntas estruturadas sobre sua situação, ajuda a capturar todos os detalhes importantes e cria uma visão geral do seu caso.\n\nO assistente usa inteligência artificial para fazer perguntas relevantes e gerar relatórios que podem ser úteis ao conversar com um advogado.",
      },
      notLegalAdvice: {
        title: "Não é consultoria jurídica",
        description:
          "IMPORTANTE: Helplix NÃO fornece aconselhamento jurídico. É uma ferramenta para ajudá-lo a documentar sua situação e obter uma compreensão geral de possíveis questões legais.\n\nO assistente pode identificar áreas jurídicas relevantes, mas isso é apenas informativo. Sempre consulte um advogado licenciado para questões legais.",
      },
      dataStorage: {
        title: "Armazenamento de dados",
        description:
          "Suas informações são armazenadas de forma segura e criptografada. Apenas você tem acesso aos seus casos através de sua conta.\n\nVocê pode excluir seus dados a qualquer momento através das configurações.",
      },
      privacy: {
    ...
    report: {
      ...
      interpretation: {
        ...
        disclaimer:
          "AVISO LEGAL: Esta é uma análise gerada por IA apenas para fins educacionais e informativos. O conteúdo NÃO constitui aconselhamento jurídico e pode conter imprecisões. Sempre consulte um advogado licenciado.",
      },
      toast: {
    ...
    settings: {
      ...
      completeCase: {
        ...
        description:
          "O caso atual será salvo como concluído e você poderá acessá-lo no histórico. Uma nova sessão será iniciada.",
        cancel: "Cancelar",
        confirm: "Concluir",
      },
      deleteConversation: {
        ...
        description:
          "Isso excluirá permanentemente o caso ativo atual e todos os dados do registro. Uma nova sessão será iniciada automaticamente. Esta ação não pode ser desfeita.",
        cancel: "Cancelar",
        confirm: "Excluir",
      },
      toast: {
      ...
      privacy: {
        ...
        storage: {
          ...
          description:
            "Seus dados são armazenados de forma criptografada em servidores seguros. Apenas você tem acesso às suas informações através da sua conta.",
        },
        ai: {
          title: "IA utilizada",
          description:
            "O Helplix usa modelos de IA do Google (Gemini) para fazer perguntas e gerar relatórios. Seus dados NÃO são usados para treinar a IA.",
        },
        security: {
          title: "Sua privacidade",
          description:
            "Nenhum outro usuário pode ver seus casos. Você pode excluir seus dados a qualquer momento através das configurações.",
        },
    ...
    history: {
      ...
      deleteConfirmDescription:
        "Esta ação não pode ser desfeita. Todos os dados deste caso serão excluídos permanentemente.",
      status: {
        active: "Ativo",
        completed: "Concluído",
        archived: "Arquivado",
  ...
  MX: {
    ...
    auth: {
      ...
      description:
        "Helplix te ayuda a documentar tu situación legal haciendo preguntas estructuradas y creando un resumen completo.",
    ...
    welcome: {
      howItWorks: {
        title: "Cómo funciona",
        description:
          "Helplix es su asistente de documentación legal. Hace preguntas estructuradas sobre su situación, ayuda a capturar todos los detalles importantes y crea un resumen de su caso.\n\nEl asistente usa inteligencia artificial para hacer preguntas relevantes y generar informes que pueden ser útiles al hablar con un abogado.",
      },
      notLegalAdvice: {
        title: "No es asesoría legal",
        description:
          "IMPORTANTE: Helplix NO proporciona asesoramiento legal. Es una herramienta para ayudarle a documentar su situación y obtener una comprensión general de posibles problemas legales.\n\nEl asistente puede identificar áreas legales relevantes, pero esto es solo informativo. Siempre consulte a un abogado licenciado para asuntos legales.",
      },
      dataStorage: {
        title: "Almacenamiento de datos",
        description:
          "Su información se almacena de forma segura y encriptada. Solo usted tiene acceso a sus casos a través de su cuenta.\n\nPuede eliminar sus datos en cualquier momento desde la configuración.",
      },
      privacy: {
    ...
    report: {
      ...
      interpretation: {
        ...
        disclaimer:
          "DESCARGO DE RESPONSABILIDAD: Este es un análisis generado por IA solo con fines educativos e informativos. El contenido NO constituye asesoramiento legal y puede contener inexactitudes. Siempre consulte con un abogado licenciado.",
      },
      toast: {
    ...
    settings: {
      ...
      completeCase: {
        ...
        description:
          "El caso actual se guardará como completado y podrás acceder a él en el historial. Se iniciará una nueva sesión.",
        cancel: "Cancelar",
        confirm: "Completar",
      },
      deleteConversation: {
        ...
        description:
          "Esto eliminará permanentemente toda la conversación y los datos del registro. Esta acción no se puede deshacer.",
        cancel: "Cancelar",
        confirm: "Eliminar",
      },
      toast: {
      ...
      privacy: {
        ...
        storage: {
          ...
          description:
            "Tus datos se almacenan de forma encriptada en servidores seguros. Solo tú tienes acceso a tu información a través de tu cuenta.",
        },
        ai: {
          title: "IA utilizada",
          description:
            "Helplix utiliza modelos de IA de Google (Gemini) para hacer preguntas y generar informes. Tus datos NO se utilizan para entrenar la IA.",
        },
        security: {
          title: "Tu privacidad",
          description:
            "Ningún otro usuario puede ver tus casos. Puedes eliminar tus datos en cualquier momento desde la configuración.",
        },
        disclaimer:
          "Helplix no proporciona asesoramiento legal. Siempre consulta a un abogado para cuestiones legales.",
      },
    ...
    history: {
      ...
      deleteConfirmDescription:
        "Esta acción no se puede deshacer. Todos los datos de este caso serán eliminados permanentemente.",
      status: {
        active: "Activo",
  ...
  DO: {
    ...
    settings: {
      ...
      deleteConversation: {
        ...
        description:
          "Esto eliminará permanentemente el caso activo actual y todos los datos del registro. Se iniciará una nueva sesión automáticamente. Esta acción no se puede deshacer.",
        cancel: "Cancelar",
        confirm: "Eliminar",
      },
      toast: {
  ...
  SE: {
    ...
    auth: {
      ...
      description:
        "Helplix hjälper dig dokumentera din juridiska situation genom strukturerade frågor och skapar en omfattande översikt.",
    ...
    welcome: {
      howItWorks: {
        ...
        description:
          "Helplix är din juridiska dokumentationsassistent. Den ställer strukturerade frågor om din situation, hjälper dig att fånga alla viktiga detaljer och skapar en översikt av ditt ärende.\n\nAssistenten använder artificiell intelligens för att ställa relevanta frågor och generera rapporter som kan vara användbara när du pratar med en jurist.",
      },
      notLegalAdvice: {
        title: "Inte juridisk rådgivning",
        description:
          "VIKTIGT: Helplix ger INTE juridisk rådgivning. Det är ett verktyg för att hjälpa dig dokumentera din situation och få en allmän förståelse för potentiella juridiska frågor.\n\nAssistenten kan identifiera relevanta rättsområden, men detta är endast informativt. Konsultera alltid en legitimerad jurist för rättsliga frågor.",
      },
      dataStorage: {
        title: "Datalagring",
        description:
          "Din information lagras säkert och krypterat. Endast du har tillgång till dina ärenden via ditt konto.\n\nDu kan radera dina data när som helst via inställningarna.",
      },
      privacy: {
    ...
    report: {
      ...
      interpretation: {
        ...
        disclaimer:
          "DISCLAIMER: Detta är en AI-genererad analys endast för utbildnings- och informationssyfte. Innehållet utgör INTE juridisk rådgivning och kan innehålla felaktigheter. Konsultera alltid en legitimerad jurist.",
      },
      toast: {
    ...
    settings: {
      ...
      completeCase: {
        ...
        description:
          "Det aktuella ärendet sparas som avslutat och du kan komma åt det i historiken. En ny session startas.",
        cancel: "Avbryt",
        confirm: "Avsluta",
      },
      deleteConversation: {
        ...
        description:
          "Detta raderar permanent det pågående ärendet och all tillhörande data. En ny session startas automatiskt. Åtgärden kan inte ångras.",
        cancel: "Avbryt",
        confirm: "Radera",
      },
      toast: {
      ...
      privacy: {
        ...
        storage: {
          title: "Säker lagring",
          description:
            "Din data lagras krypterat på säkra servrar. Endast du har tillgång till din information via ditt konto.",
        },
        ai: {
          title: "AI som används",
          description:
            "Helplix använder AI-modeller från Google (Gemini) för att ställa frågor och generera rapporter. Din data används INTE för att träna AI:n.",
        },
        security: {
          title: "Din integritet",
          description:
            "Ingen annan användare kan se dina ärenden. Du kan radera din data när som helst via inställningarna.",
        },
  ...
  US: {
    ...
    auth: {
      ...
      description:
        "Helplix helps you document your legal situation by asking structured questions and creating a comprehensive overview.",
    ...
    welcome: {
      howItWorks: {
        title: "How it works",
        description:
          "Helplix is your legal documentation assistant. It asks structured questions about your situation, helps capture all important details, and creates an overview of your case.\n\nThe assistant uses artificial intelligence to ask relevant questions and generate reports that can be useful when talking to a lawyer.",
      },
      notLegalAdvice: {
        title: "Not legal advice",
        description:
          "IMPORTANT: Helplix does NOT provide legal advice. It is a tool to help you document your situation and get a general understanding of potential legal issues.\n\nThe assistant can identify relevant legal areas, but this is for informational purposes only. Always consult a licensed attorney for legal matters.",
      },
      dataStorage: {
        title: "Data storage",
        description:
          "Your information is stored securely and encrypted. Only you have access to your cases through your account.\n\nYou can delete your data at any time from the settings.",
      },
      privacy: {
    ...
    report: {
      ...
      interpretation: {
        ...
        disclaimer:
          "DISCLAIMER: This is an AI-generated analysis for educational and informational purposes only. The content does NOT constitute legal advice and may contain inaccuracies. Always consult with a licensed attorney.",
      },
      toast: {
    ...
    settings: {
      ...
      completeCase: {
        ...
        description:
          "The current case will be saved as completed and you can access it in the history. A new session will start.",
        cancel: "Cancel",
        confirm: "Complete",
      },
      deleteConversation: {
        ...
        description:
          "This will permanently delete the active case and all its data. A new session will start automatically. This action cannot be undone.",
        cancel: "Cancel",
        confirm: "Delete",
      },
      toast: {
      ...
      privacy: {
        ...
        storage: {
          ...
          description:
            "Your data is stored encrypted on secure servers. Only you have access to your information through your account.",
        },
        ai: {
          title: "AI used",
          description:
            "Helplix uses AI models from trusted providers to ask questions and generate reports. Your data is NOT used to train the AI.",
        },
        security: {
          title: "Your privacy",
  ...
  NL: {
    ...
    auth: {
      ...
      description:
        "Helplix helpt u uw juridische situatie te documenteren door gestructureerde vragen te stellen en een uitgebreid overzicht te maken.",
    ...
    welcome: {
      howItWorks: {
        title: "Hoe het werkt",
        description:
          "Helplix is uw juridische documentatie-assistent. Het stelt gestructureerde vragen over uw situatie, helpt alle belangrijke details vast te leggen en maakt een overzicht van uw zaak.\n\nDe assistent gebruikt kunstmatige intelligentie om relevante vragen te stellen en rapporten te genereren die nuttig kunnen zijn bij een gesprek met een advocaat.",
      },
      notLegalAdvice: {
        title: "Geen juridisch advies",
        description:
          "BELANGRIJK: Helplix geeft GEEN juridisch advies. Het is een hulpmiddel om u te helpen uw situatie te documenteren en een algemeen begrip te krijgen van mogelijke juridische kwesties.\n\nDe assistent kan relevante rechtsgebieden identificeren, maar dit is alleen ter informatie. Raadpleeg altijd een erkende advocaat voor juridische zaken.",
      },
      dataStorage: {
        title: "Gegevensopslag",
        description:
          "Uw informatie wordt veilig en versleuteld opgeslagen. Alleen u heeft toegang tot uw zaken via uw account.\n\nU kunt uw gegevens op elk moment verwijderen via de instellingen.",
      },
      privacy: {
        title: "AI en privacy",
        description:
    ...
    report: {
      ...
      interpretation: {
        ...
        placeholder:
          'Klik op "Rapport genereren" om een door AI gegenereerde juridische interpretatie van de zaak te krijgen.',
        disclaimer:
          "DISCLAIMER: Dit is een door AI gegenereerde analyse alleen voor educatieve en informatieve doeleinden. De inhoud vormt GEEN juridisch advies en kan onjuistheden bevatten. Raadpleeg altijd een erkende advocaat.",
      },
      toast: {
    ...
    settings: {
      ...
      completeCase: {
        ...
        description:
          "De huidige zaak wordt opgeslagen als afgerond en is toegankelijk in de geschiedenis. Een nieuwe sessie wordt gestart.",
        cancel: "Annuleren",
        confirm: "Afronden",
      },
      deleteConversation: {
        ...
        description:
          "Dit verwijdert permanent de actieve zaak en alle bijbehorende gegevens. Een nieuwe sessie wordt automatisch gestart. Deze actie kan niet ongedaan worden gemaakt.",
        cancel: "Annuleren",
        confirm: "Verwijderen",
      },
      toast: {
      ...
      privacy: {
        ...
        storage: {
          ...
          description:
            "Je gegevens worden versleuteld opgeslagen op beveiligde servers. Alleen jij hebt toegang tot je informatie via je account.",
        },
        ai: {
          title: "Gebruikte AI",
          description:
            "Helplix gebruikt AI-modellen van Google (Gemini) om vragen te stellen en rapporten te genereren. Je gegevens worden NIET gebruikt om de AI te trainen.",
        },
        security: {
          title: "Je privacy",
          description:
            "Geen andere gebruiker kan je zaken zien. Je kunt je gegevens op elk moment verwijderen via de instellingen.",
        },
    ...
    history: {
      ...
      deleteConfirmDescription:
        "Deze actie kan niet ongedaan worden gemaakt. Alle gegevens voor deze zaak worden permanent verwijderd.",
      status: {
        active: "Actief",
        completed: "Voltooid",
